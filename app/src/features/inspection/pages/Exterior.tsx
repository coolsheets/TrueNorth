...
export default function Exterior() {
  ...
  const sectionSchema = sections.find(s => s.slug === 'exterior');
  ...
  useEffect(() => {
    async function loadDraft() {
      ...
      try {
        ...
        const sectionData = draft.sections.find(s => s.slug === 'exterior');
        if (sectionData) {
    ...
    <Stack spacing={3}>
      <Card>
        ...
        <Typography color="text.secondary" paragraph>
          Check body panels, paint, glass, and lights for damage or defects.
        </Typography>
        ...
        {!draft ? (
          ...
          <>
            ...
            <Stack direction="row" spacing={2} sx={{ mt: 4 }}>
              ...
              <Button
                variant="outlined"
                onClick={() => nav(`/vehicle?draftId=${draftId}`)}
              >
                Back
              </Button>
            </Stack>
